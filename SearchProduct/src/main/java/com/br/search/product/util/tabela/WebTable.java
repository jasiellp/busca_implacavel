package com.br.search.product.util.tabela;
...
public class WebTable 
{
	...
	public static WebTable NovaTabela(ResultSet resultSet) throws SQLException
	{
		return new WebTable(resultSet);
	}
	
	
	public static WebTable NovaTabela() throws SQLException
	{
		return new WebTable();
	}
	...
	private boolean InfoCompare(WebTable tabela)
	{ 
	...
	private WebTable (ResultSet resultSet) throws SQLException
	{	
        ...
        { 
            ...
            {	
            	...
            	{
            		valor__[j-1] = WebTable.NovaTabela(null);
            	} 
	...
	public void concatenarTabela(WebTable novaTabela)
	{
	...
	public void viewTable()
	{
		 ...
		 ViewTable frame = new ViewTable(valor,this.valor_info[0]);
	...
	public WebTable getTable(String coluna,int linha)
	{  
		Object objRetorno = valor[linha][getIdColuna(coluna)];
		if (objRetorno instanceof Double) 
		{ 
			return ((WebTable) objRetorno);	
		}
		else
		{
			return objRetorno == null?null:(WebTable) objRetorno;	
		}
	}
	 
	public WebTable getTable(int coluna,int linha)
	{ 
	...
	public void setTable(String coluna,int linha, WebTable tValor)
	{
		this.valor[linha][getIdColuna(coluna)] = tValor; 
	}
	
	public void setTable(int coluna,int linha, WebTable tValor)
	{
